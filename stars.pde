...
class FlickeringStar {
  ...
  void draw() {
    final float[] o = {1, 0, 0, 1, -1, 0, 0, -1, 1.5, -1.5, -2};
    stroke(c);
    fill(c);
    beginShape();
    ...
    bezierVertex(x+o[9]*r*e, y+o[9]*r*e, x+o[9]*r*e, y+o[9]*r*e, x+o[9]*r, y+o[4]*r);
    bezierVertex(x+o[1]*r*e, y+o[1]*r*e, x+o[1]*r*e, y+o[1]*r*e, x+o[9]*r, y+o[0]*r);
    bezierVertex(x+o[1]*r*e, y+o[1]*r*e, x+o[1]*r*e, y+o[8]*r*e, x+o[9]*r, y+o[10]*r);
    endShape();
  }
